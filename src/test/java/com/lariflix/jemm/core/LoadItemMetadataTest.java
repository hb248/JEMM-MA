...
public class LoadItemMetadataTest {
    ...
    public void testGetFullURL() {
        ...
        loadItemMetadata.setcUserAdminID("admin");
        loadItemMetadata.setcItemID("item1");
        assertEquals("http://localhost:8096/Users/admin/Items/item1?Fields=MediaSources,MediaStreams,Path,Overview,People,Genres,Tags,Studios,OriginalTitle,SortName,ForcedSortName&ApiKey=1234567890", loadItemMetadata.getFullURL());
    }
}