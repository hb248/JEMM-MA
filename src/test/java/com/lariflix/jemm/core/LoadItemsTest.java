...
public class LoadItemsTest {
    ...
    public void testGetFullURL() {
        ...
        loadItems.setcUserAdminID("admin");
        loadItems.setcParentID("parent1");
        assertEquals("http://localhost:8096/Users/admin/Items?parentId=parent1&userId=admin&ApiKey=1234567890&Fields=People,Genres,Studios,Tags,Overview,DateCreated,PremiereDate,ProductionYear,OfficialRating,CustomRating,SortName,OriginalTitle,ProviderIds,Path&filters=IsNotFolder", loadItems.getFullURL());
    }
}